...
public class EmployeesDatabase {
    public static void addEmployee(Employee emp, Database database) throws SQLException {
    ...
    public static String[] getEmployeesIDs(Database database) throws SQLException {
        ArrayList<Employee> employees = getAllEmployees(database);
    ...
    public static Employee getEmployeeByID(String id, Database database) throws SQLException {
        Employee emp = new Employee();
    ...
    public static void editEmployee(Employee emp, Database database) throws SQLException {
